 ...
 * CDN predated that change. Nothing failed — the consumer simply bound the LEGACY texture tree on
...
export const WEAPONTEX_INDEX_ROOTS = [
	...
	// content hash exactly like a weapon's (`glove_slick_normal_tga_3a809923.png`), so a consumer can
...
/**
 * Files a consumer reads as CONFIGURATION rather than as content: the recipe manifest and
...
/**
 * Content a consumer fetches, on names the exporter does NOT content-hash — so it changes under a
