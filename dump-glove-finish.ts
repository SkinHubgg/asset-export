 ...
 * `dump-sticker-slots.ts` and `dump-attachments.ts`: read the shipped data once, commit the table.
 *
 *   bun run tools/cs2-export/dump-glove-finish.ts
 *
 * ------------------------------------------------------------------------------------------------
 * WHAT IS BEING READ
 *
...
import { cliPath, findCs2Pak, requireCli } from './platform'
...
const emit = (finishes: Record<string, GloveFinish>, byFamily: number[]) => {
	...
	return `// GENERATED by tools/cs2-export/dump-glove-finish.ts — do not edit by hand.
//
