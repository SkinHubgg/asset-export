...
// SPIR-V source (30728 bytes), GLSL reflection with SPIRV-Cross by KhronosGroup
// Static combos: S_PAINT_STYLE=2, S_USE_ALL_MASKS, S_SEPARATE_CHANNEL_INPUTS, S_OVERLAY_TEXTURE
...
layout(set = 1) uniform _1664 _Globals_;
...
void main()
{
    ...
    for (;;)
    {
        ...
        _19130 = _13155 + (texture(sampler2D(g_tPosition, g_sTrilinearClamp), (input_1.xy + (_250[_16208] * 0.20000000298023223876953125)).xy) * 0.0588235296308994293212890625);
        _18752 = _16208 + 1;
        _13155 = _19130;
        _16208 = _18752;
        continue;
    ...
    vec4 _21761 = texture(sampler2D(g_tOverlay, g_sTrilinearWrap), input_3.xy);
    vec4 _19017;
    SPIRV_CROSS_BRANCH
    switch (_Globals_.nOverlayMaskMode)
    {
        ...
        {
            vec4 _7572 = _21761;
            _7572.w = (_21761.w * (1.0 - max(_22743.x, max(_22743.y, _22743.z)))) * (1.0 - max(_12552.y, _12552.z));
            _19017 = _7572;
            break;
        }
        case 2:
        {
            vec4 _7571 = _21761;
            _7571.w = (_21761.w * (_22743.x * (1.0 - max(_22743.y, _22743.z)))) * (1.0 - max(_12552.y, _12552.z));
            _19017 = _7571;
            break;
        }
        case 3:
        {
            vec4 _18606 = _21761;
            _18606.w = _21761.w * (max(_22743.y * (1.0 - _22743.z), _12552.y) * (1.0 - _12552.z));
            _19017 = _18606;
            break;
        }
        case 4:
        {
            vec4 _18605 = _21761;
            _18605.w = _21761.w * max(_22743.z * (1.0 - _12552.y), _12552.z);
            _19017 = _18605;
            break;
        }
        case 5:
        {
            vec4 _18604 = _21761;
            _18604.w = _21761.w * max(_22743.x, max(_22743.y, max(_22743.z, max(_12552.y, _12552.z))));
            _19017 = _18604;
            break;
        }
        case 7:
        {
            vec4 _18603 = _21761;
            _18603.w = _21761.w * (1.0 - max(_12552.y, _12552.z));
            _19017 = _18603;
            break;
        }
        default:
    ...
    vec4 _22799 = vec4(_19017.xyz * _Globals_.g_fOverlayBrightness, _8479);
    float _6970 = _19068.x * mix(smoothstep(0.0, 0.680000007152557373046875, pow(_4306, 1.10000002384185791015625)), smoothstep(0.0, 0.5099999904632568359375, pow(_4306, 0.800000011920928955078125)), pow(_Globals_.g_flWearAmount, 0.300000011920928955078125));
    float _20190 = (_Globals_.g_flWearAmount * 6.0) + 1.0;
    float _10030 = _12552.y;
    float _11018 = _12552.z;
    float _8103 = mix(mix(mix(mix(mix(_Globals_.g_vPaintDurability.x, _Globals_.g_vPaintDurability.y, _22743.x), _Globals_.g_vPaintDurability.z, _22743.y), _Globals_.g_vPaintDurability.w, _22743.z), _Globals_.g_vPaintDurability.z, _10030), _Globals_.g_vPaintDurability.w, _11018);
    float _5486 = (((_18087.w + _6970) * _20190) * mix(1.0, _Globals_.g_fOverlayDurability, _19017.w)) * _8103;
    ...
    float _24609 = 0.560000002384185791015625 - _4693;
    float _23367 = 0.7400000095367431640625 + _4693;
    float _20939 = smoothstep(_24609, _23367, _5486);
    float _23189 = smoothstep(_24609, _23367, (_6970 * _20190) * _Globals_.g_fOverlayDurability);
    float _21710;
    SPIRV_CROSS_BRANCH
    if (_Globals_.nOverlayMaskMode == 0)
    {
        _21710 = max(0.0, mix(_20939, min(_20939, _23189), _8479));
    }
    else
    {
        _21710 = _20939;
    ...
    if (_Globals_.bRoughnessMode != 0)
    {
        ...
        if (_14878)
        {
            _21711 = mix(mix(_12885, _Globals_.g_vPaintRoughness.z, _10030), _Globals_.g_vPaintRoughness.w, _11018);
        }
        else
        {
            _21711 = _12885;
        ...
        vec4 _17156 = vec4(_21362, _23035, _9193, min(1.0, _Globals_.g_flPearlescentScale));
        _17156.z = _19513;
        _11711 = _17156;
        _10247 = _13705;
    }
    ...
    if (_Globals_.bRoughnessMode == 0)
    {
        ...
        vec3 _18755 = mix(mix(mix(mix(mix(mix(_Globals_.g_vColor0, _Globals_.g_vColor1, vec3(_12931)), _Globals_.g_vColor2, vec3(_13767)), _Globals_.g_vColor3, vec3(_14497)), _Globals_.g_vColor2, vec3(_10030)), _Globals_.g_vColor3, vec3(_11018)).xyz, _22737, _24345);
        vec3 _21712;
        SPIRV_CROSS_BRANCH
        ...
        vec3 _19616 = saturate(_21712 * mix(_Globals_.g_flColorBrightness, 1.0, smoothstep(0.5299999713897705078125 - _4693, 0.7200000286102294921875 + _4693, _5486) * (1.0 - (smoothstep(0.5, 0.60000002384185791015625, _22743.w) * smoothstep(1.0, 0.89999997615814208984375, _22743.w)))));
