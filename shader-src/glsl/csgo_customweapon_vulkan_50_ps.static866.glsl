...
// SPIR-V source (29420 bytes), GLSL reflection with SPIRV-Cross by KhronosGroup
// Static combos: S_PAINT_STYLE=2, S_SEPARATE_CHANNEL_INPUTS, S_OVERLAY_TEXTURE
...
void main()
{
    ...
    for (;;)
    {
        ...
        _19130 = _13155 + (texture(sampler2D(g_tPosition, g_sTrilinearClamp), (input_1.xy + (_118[_16208] * 0.20000000298023223876953125)).xy) * 0.0588235296308994293212890625);
        _18752 = _16208 + 1;
        _13155 = _19130;
        _16208 = _18752;
        continue;
    ...
    switch (_Globals_.nOverlayMaskMode)
    {
        ...
        {
            vec4 _18607 = _21761;
            _18607.w = _21761.w * (1.0 - max(_22743.x, max(_22743.y, _22743.z)));
            _19017 = _18607;
            break;
        }
        case 2:
        {
            vec4 _18606 = _21761;
            _18606.w = _21761.w * (_22743.x * (1.0 - max(_22743.y, _22743.z)));
            _19017 = _18606;
            break;
        }
        case 3:
        {
            vec4 _18605 = _21761;
            _18605.w = _21761.w * (_22743.y * (1.0 - _22743.z));
            _19017 = _18605;
            break;
        }
        case 4:
        ...
        {
            vec4 _18603 = _21761;
            _18603.w = _21761.w * max(_22743.x, max(_22743.y, _22743.z));
            _19017 = _18603;
            break;
        }
        case 7:
    ...
    float _5486 = (((_18087.w + _6970) * _20190) * mix(1.0, _Globals_.g_fOverlayDurability, _19017.w)) * _10779;
