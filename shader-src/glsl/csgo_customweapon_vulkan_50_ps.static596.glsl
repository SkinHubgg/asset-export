...
// SPIR-V source (26896 bytes), GLSL reflection with SPIRV-Cross by KhronosGroup
// Static combos: S_PAINT_STYLE=2, S_USE_ALL_MASKS, S_OVERLAY_TEXTURE
...
void main()
{
    ...
    for (;;)
    {
        ...
        _19130 = _13155 + (texture(sampler2D(g_tPosition, g_sTrilinearClamp), (input_1.xy + (_195[_16208] * 0.20000000298023223876953125)).xy) * 0.0588235296308994293212890625);
        _18752 = _16208 + 1;
        _13155 = _19130;
        _16208 = _18752;
        continue;
    ...
    switch (_Globals_.nOverlayMaskMode)
    {
        ...
        {
            vec4 _7572 = _21760;
            _7572.w = (_21760.w * (1.0 - max(_22743.x, max(_22743.y, _22743.z)))) * (1.0 - max(_12552.y, _12552.z));
            _19017 = _7572;
            break;
        }
        case 2:
        {
            vec4 _7571 = _21760;
            _7571.w = (_21760.w * (_22743.x * (1.0 - max(_22743.y, _22743.z)))) * (1.0 - max(_12552.y, _12552.z));
            _19017 = _7571;
            break;
        }
        case 3:
        {
            vec4 _18606 = _21760;
            _18606.w = _21760.w * (max(_22743.y * (1.0 - _22743.z), _12552.y) * (1.0 - _12552.z));
            _19017 = _18606;
            break;
        }
        case 4:
        {
            vec4 _18605 = _21760;
            _18605.w = _21760.w * max(_22743.z * (1.0 - _12552.y), _12552.z);
            _19017 = _18605;
            break;
        }
        case 5:
        {
            vec4 _18604 = _21760;
            _18604.w = _21760.w * max(_22743.x, max(_22743.y, max(_22743.z, max(_12552.y, _12552.z))));
            _19017 = _18604;
            break;
        }
        case 7:
        {
            vec4 _18603 = _21760;
            _18603.w = _21760.w * (1.0 - max(_12552.y, _12552.z));
            _19017 = _18603;
            break;
        }
        default:
    ...
    float _5486 = (((_19372.w + _7402) * _10548) * mix(1.0, _Globals_.g_fOverlayDurability, _19017.w)) * _8103;
    ...
    if (_Globals_.bRoughnessMode != 0)
    {
        ...
        _19391.x = _19391.x;
        bool _14877 = _Globals_.g_bRoughnessPerColor != 0;
        float _12885;
        SPIRV_CROSS_BRANCH
        if (_14877)
        {
