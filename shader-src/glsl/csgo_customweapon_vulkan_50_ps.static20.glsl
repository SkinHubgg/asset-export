...
// SPIR-V source (18704 bytes), GLSL reflection with SPIRV-Cross by KhronosGroup
// Static combos: S_PAINT_STYLE=2, S_USE_ALL_MASKS
...
void main()
{
    ...
    for (;;)
    {
        ...
        _19130 = _13155 + (texture(sampler2D(g_tPosition, g_sTrilinearClamp), (input_1.xy + (_20[_16208] * 0.20000000298023223876953125)).xy) * 0.0588235296308994293212890625);
        _18752 = _16208 + 1;
        _13155 = _19130;
        _16208 = _18752;
        continue;
    ...
    float _5486 = ((_19372.w + (_19068.x * _4306)) * ((_Globals_.g_flWearAmount * 6.0) + 1.0)) * _8103;
    ...
    if (_Globals_.bRoughnessMode != 0)
    {
        ...
        vec4 _14119 = mix(vec4(min(1.0, _20271 + ((((1.0 - _16529.w) * _Globals_.g_flWearAmount) * _Globals_.g_flWearAmount) * 0.5)), _22165, 0.0, 1.0), _19391, vec4(_21647));
