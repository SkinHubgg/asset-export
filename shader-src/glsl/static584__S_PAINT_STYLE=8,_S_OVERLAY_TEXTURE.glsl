...
// SPIR-V source (21044 bytes), GLSL reflection with SPIRV-Cross by KhronosGroup
// Static combos: S_PAINT_STYLE=8, S_OVERLAY_TEXTURE
...
layout(set = 1) uniform _965 _Globals_;
...
layout(set = 1, binding = 38) uniform texture2D g_tOverlayMask;
...
void main()
{
    ...
    float _14472 = (((min(_19372.w, _13255) + _7402) * _10547) + (smoothstep(0.5, 0.60000002384185791015625, _22381) * smoothstep(1.0, 0.89999997615814208984375, _22381))) * _10021;
    ...
    if (_Globals_.bRoughnessMode != 0)
    {
        ...
        float _24500 = 1.0 - min(1.0, _22381 * 2.0);
        ...
        float _20709 = saturate((((mix(_Globals_.g_flPaintRoughness, mix(((_24500 * _24500) * 0.85000002384185791015625) + 0.1500000059604644775390625, _Globals_.g_flPaintRoughness, float(_22381 >= 0.5)), _17150) * mix(1.0, 0.89999997615814208984375, _8353)) + (((1.0 - _9781) * _Globals_.g_flWearAmount) * 0.0500000007450580596923828125)) + (((1.0 - _24589) * 0.1500000059604644775390625) * _Globals_.g_flWearAmount)) + (_19555 * 0.1500000059604644775390625));
        float _22792 = mix(mix(1.0, pow((_24589 * _23988) * _9781, 0.5), _Globals_.g_flWearAmount), 1.0, _8353);
        ...
        _12896.y = mix(mix(mix(_Globals_.g_flPaintMetalness, _20322.y, _21710), _22792, _17150), _Globals_.g_fOverlayMetalness, _10825);
        _12896.z = _7921;
        vec4 _19018;
