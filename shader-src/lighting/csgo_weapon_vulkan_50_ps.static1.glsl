...
// cbuffer ID 5618 (name: _Globals_), member index 35 (name: g_cInvulnerabilityColor) cannot be expressed with either HLSL packing layout or packoffset.
//
// Re-attempting reflection with the GLSL backend.

// Source 2 Viewer 19.2.0.0 - https://valveresourceformat.github.io
// SPIR-V source (67268 bytes), GLSL reflection with SPIRV-Cross by KhronosGroup
// Static combos: S_ENABLE_ADJUSTMENTS
...
struct _2589
{
    ...
    uint g_tDetail;
    float g_fTextureRoughnessContrast;
    float g_fTextureRoughnessBrightness;
    float g_fHueShift;
    float g_fSaturation;
    float g_fContrast;
    float g_fBrightness;
    int g_nDetailBlendMode;
    float g_fDetailBlendFactor;
    int bIridescence;
...
layout(set = 1) uniform _2589 _Globals_;
...
layout(set = 3) uniform _263 PerViewLightingConstantBufferGpu_t;
...
void main()
{
    ...
    if (_15436)
    {
        vec3 _10413 = input_2 + PerViewConstantBufferCsgo_t._m27.xyz;
        vec2 _18197 = input_4.xy * 2.5;
        vec2 _20826;
        if ((length(cross(vec3(dFdx(input_4.xy), 0.0), vec3(dFdy(input_4.xy), 0.0))) / max(9.9999997473787516355514526367188e-05, length(cross(dFdx(_10413), dFdy(_10413))))) < 0.00200000009499490261077880859375)
        {
            _20826 = _18197 * 3.0;
        }
        else
        ...
        float _10538 = saturate((((_12497 * 0.25) - fract(_12471 + (((_Globals_.g_flRainExposureLocalTimer * 0.100000001490116119384765625) * PerViewConstantBufferCsgo_t._m12) * PerViewConstantBufferCsgo_t._m12))) * 5.0) / (PerViewConstantBufferCsgo_t._m13 + 0.001000000047497451305389404296875)) * saturate((input_3.z + 0.75) * 4.0);
        vec2 _13861 = input_4.xy + (((_8562.xy * (-0.0199999995529651641845703125)) * _10538) * _7729);
        vec4 _20488;
        _20488.x = _13861.x;
        _20488.y = _13861.y;
        _13136 = _10538;
    ...
    vec3 _10061 = input_2 + PerViewConstantBufferCsgo_t._m27.xyz;
    ...
    vec3 _21103 = _19680.xyz * input_5.xyz;
    ...
    vec3 _12631 = input_3.xyz * (_24327 ? (-1.0) : 1.0);
    float _23240 = (input_7.w > 0.0) ? 1.0 : (-1.0);
    vec3 _14435 = cross(_12631.xyz, input_7.xyz) * _23240;
    ...
    vec3 _7054 = normalize((((input_7.xyz * _20480.x).xyz + (_7424.xyz * _20480.y)).xyz + (_12631.xyz * _20480.z)).xyz);
    vec3 _6616;
    vec3 _13137;
    float _13694;
    vec2 _16306;
    ...
    if (_15436)
    {
        ...
        _17115 = mix(normalize(mix(_24347, _7054, vec3(1.0 + (_23650 * 1.5)))), normalize((((input_7.xyz * _13998.x).xyz + (_7424.xyz * _13998.y)).xyz + (_24347.xyz * _8927)).xyz), vec3(_18483));
    ...
    vec4 _21761 = texture(sampler2D(g_bindless_Texture2D_float4[_Globals_.g_tDetail], g_bindless_Sampler[_Globals_.g_sUserConfig]), input_1.xy);
    vec3 _21710;
    SPIRV_CROSS_BRANCH
    if (_Globals_.g_nDetailBlendMode == 1)
    {
        _21710 = mix(_13137.xyz, _21761.xyz, vec3(_Globals_.g_fDetailBlendFactor));
    }
    else
    {
        _21710 = mix(_13137.xyz, _13137.xyz * _21761.xyz, vec3(_Globals_.g_fDetailBlendFactor));
    }
    vec3 _18810 = saturate(mix(vec3(0.5), _21710.xyz, vec3(_Globals_.g_fContrast)) * _Globals_.g_fBrightness);
    vec3 _19241 = _18810.xyz;
    float _12442 = cos(_Globals_.g_fHueShift);
    float _12935;
    do
    {
        float _17002 = _18810.x;
        float _10964 = _18810.y;
        float _21520 = _18810.z;
    ...
    vec3 _24555 = mix(vec3(dot(_18810.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125))), ((_19241 * _12442) + (cross(vec3(0.57735002040863037109375), _19241) * sin(_Globals_.g_fHueShift))) + ((vec3(0.57735002040863037109375) * dot(vec3(0.57735002040863037109375), _19241)) * (1.0 - _12442)), vec3(pow(_12935, 0.125)));
    vec3 _24098 = saturate(mix(vec3(dot(_24555.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125))), _24555.xyz, vec3(_Globals_.g_fSaturation)));
    float _9635 = _24098.x;
    float _21384 = _24098.y;
    float _24623 = _24098.z;
    vec3 _20195;
    SPIRV_CROSS_BRANCH
    if (_Globals_.g_flPearlescentScale != 0.0)
    {
        vec3 _16414 = _24098.xyz;
        ...
        do
        {
            float _18474 = max(_9635, max(_21384, _24623));
            if (_18474 == 0.0)
            {
                _12936 = 0.0;
                break;
            }
            _12936 = (_18474 - min(_9635, min(_21384, _24623))) / _18474;
            break;
        } while(false);
        _20195 = mix(vec3(dot(_24098.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125))), ((_16414 * _15271) + (cross(vec3(0.57735002040863037109375), _16414) * sin(_21433))) + ((vec3(0.57735002040863037109375) * dot(vec3(0.57735002040863037109375), _16414)) * (1.0 - _15271)), vec3(pow(_12936, 0.125)));
    }
    else
    {
        _20195 = _24098;
    ...
    vec3 _9739 = input_3.xyz * (_24328 ? (-1.0) : 1.0);
    vec3 _24682 = cross(_9739.xyz, input_7.xyz) * _23240;
    vec3 _7425;
    if (_20058)
    {
        _7425 = -_24682;
    ...
    vec3 _14786 = normalize((((input_7.xyz * _20481.x).xyz + (_7425.xyz * _20481.y)).xyz + (_9739.xyz * _20481.z)).xyz);
    ...
    vec2 _11004 = max(saturate((((_16306.xy - vec2(0.5)) * _Globals_.g_fTextureRoughnessContrast) + vec2(0.5)).xy * _Globals_.g_fTextureRoughnessBrightness).xy, vec2(pow(saturate(max(dot(_10347, _10347), dot(_12420, _12420))), 0.333000004291534423828125)));
    vec3 _10171 = -_24347;
    ...
    if (_24465.x)
    {
        ...
        vec4 _10010 = normalize(vec4(PerViewLightingConstantBufferGpu_t._m7.x * fma(dot(_10171, normalize(vec3(PerViewLightingConstantBufferGpu_t._m6._m0[0].xy, 0.25))), 0.5, 0.5), PerViewLightingConstantBufferGpu_t._m7.y * fma(dot(_10171, normalize(vec3(PerViewLightingConstantBufferGpu_t._m6._m0[1].xy, 0.25))), 0.5, 0.5), PerViewLightingConstantBufferGpu_t._m7.z * fma(dot(_10171, normalize(vec3(PerViewLightingConstantBufferGpu_t._m6._m0[2].xy, 0.25))), 0.5, 0.5), PerViewLightingConstantBufferGpu_t._m7.w * fma(dot(_10171, normalize(vec3(PerViewLightingConstantBufferGpu_t._m6._m0[3].xy, 0.25))), 0.5, 0.5)));
    ...
    if (PerViewLightingConstantBufferGpu_t._m18 != 0)
    {
        ...
        for (;;)
        {
            ...
            vec4 _18322 = vec4(input_2.xyz, 1.0) * PerViewLightingConstantBufferGpu_t._m25._m0[_13039];
        ...
        if (_10191 >= 0)
        {
            ...
            if (_13138 < 1.0)
            {
                ...
                {
                    int _15335 = _10191 + 1;
                    vec4 _19671 = vec4(input_2.xyz, 1.0) * PerViewLightingConstantBufferGpu_t._m25._m0[_15335];
                ...
                _12506 = mix(_7934, _23727, _13138);
            }
            else
            {
                _12506 = _23727;
        ...
        float _13279 = mix(_19363, 1.0, saturate((distance(_10061.xyz, PerViewConstantBuffer_t._m6) * PerViewLightingConstantBufferGpu_t._m24) + PerViewLightingConstantBufferGpu_t._m23));
        float _12507;
        if (_24465.y)
        {
    ...
    if ((dot(PerViewLightingConstantBufferGpu_t._m16.xyz, _24735) * _21713) > 0.0)
    {
        ...
        if (_13694 > 0.0)
        {
            ...
            _18223 = mix(_17874.xyz, vec3((((0.5 + (_13811 * 0.5)) + pow(1.0 - saturate(_8780), 4.0)) * saturate((_8780 + 0.20000000298023223876953125) * 4.0)) * saturate(mix(dot(mix(_24735, _15460, vec3(10.0)), PerViewLightingConstantBufferGpu_t._m16.xyz), 1.0, _8124))), vec3(_8124));
        }
        else
        {
            _18223 = _17874;
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            do
            {
                ...
                {
                    _12890 = !all(lessThanEqual(abs((g_BarnLights_1._m0[_12608]._m15 * vec4(input_2.xyz, 1.0)).xyz), vec3(1.0)));
                }
                if (_12890)
                {
                    _13212 = _13140;
                ...
                {
                    vec3 _10017 = g_BarnLights_1._m0[_12608]._m2.xyz - input_2.xyz;
                ...
                vec3 _12283 = normalize(_11179.xyz + _21890).xyz;
                vec3 _19014 = _15462.xyz;
                float _12387 = dot(_12283, _19014);
                ...
                _13212 = _13140.xyz + ((((_22671.xyz + ((vec3(1.0) - _22671.xyz) * pow(max(9.9999999747524270787835121154785e-07, 1.0 - max(0.0, dot(_11179.xyz, _12283))), 5.0))) * ((_24199 * _24199) / ((4.0 * ((_13812 * _19571) + _6836)) * ((max(0.0, dot(_19014, _21890)) * _19571) + _6836)))).xyz * _13812).xyz * _21549.xyz);
    ...
    vec3 _22686 = (_13139.xyz + ((_18708 * (vec3(1.0) - (_7300 + _23208))).xyz * _13436).xyz) * (_20195.xyz * pow(1.0 - _20079, _Globals_.g_flMetalnessTransitionBias)).xyz;
    float _12931 = _22686.x;
    vec4 _11205 = vec4(_12931, _22686.yz, input_5.w);
    _11205.x = _12931;
    _11205.y = _22686.y;
    _11205.z = _22686.z;
    vec3 _15752 = _11205.xyz + ((_16324 * (vec3(1.0) + (_22671 * ((0.125 * (_19582 * _19582)) * saturate(dot(_17892, _19257)))))).xyz * _13436).xyz;
    vec4 _20493 = _11205;
    _20493.x = _15752.x;
    _20493.y = _15752.y;
    _20493.z = _15752.z;
    vec3 _15733 = _20493.xyz + ((((_17116 / vec3(_16309)).xyz * min(dot(_18708.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125)) / dot(vec4(_19081, 1.0), (_13141 / vec4(_16309)).xyzw), max((_17751 * PerViewLightingConstantBufferGpu_t._m4.x) + PerViewLightingConstantBufferGpu_t._m4.y, 1.0))).xyz * (_7300 + _23208)).xyz * _13436).xyz;
    vec4 _13888 = _20493;
    _13888.x = _15733.x;
    _13888.y = _15733.y;
    _13888.z = _15733.z;
    ...
    if (_Globals_.g_bFogEnabled != 0)
    {
        ...
        do
        {
            ...
            if (_12893)
            {
                ...
                vec2 _9342 = saturate(PerViewConstantBufferCsgo_t._m18.xy + (PerViewConstantBufferCsgo_t._m18.zw * vec2(mix(_17979, _17979 * PerViewConstantBufferCsgo_t._m30.y, _Globals_.g_flFogModificationAmount), _10061.z)));
                ...
                _19340 = mix(_13888.xyz, vec4(PerViewConstantBufferCsgo_t._m20.xyz, _12715).xyz, vec3(_12715));
                break;
            }
            _19340 = _13888.xyz;
            break;
    ...
    if (input_5.w < 1.0)
    {
        if ((fma(input_5.w, 2.0, -1.5) + texelFetch(g_bindless_Texture2D_float4[PerViewConstantBufferCsgo_t._m4], ivec3(ivec2(_11408.xy) & PerViewConstantBufferCsgo_t._m14, 0).xy, 0).y) < 0.0)
        {
            discard;
        }
    }
